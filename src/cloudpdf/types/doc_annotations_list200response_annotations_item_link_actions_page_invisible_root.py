...
class DocAnnotationsList200ResponseAnnotationsItemLinkActionsPageInvisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLinkActionsPageInvisibleRootType
    subtype: str
