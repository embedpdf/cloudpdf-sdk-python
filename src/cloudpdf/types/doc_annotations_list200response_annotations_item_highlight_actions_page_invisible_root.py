...
class DocAnnotationsList200ResponseAnnotationsItemHighlightActionsPageInvisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemHighlightActionsPageInvisibleRootType
    subtype: str
