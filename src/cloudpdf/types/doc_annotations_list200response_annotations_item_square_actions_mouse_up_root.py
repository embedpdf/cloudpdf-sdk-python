...
class DocAnnotationsList200ResponseAnnotationsItemSquareActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquareActionsMouseUpRootType
    subtype: str
