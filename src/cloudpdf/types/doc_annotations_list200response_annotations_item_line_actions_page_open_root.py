...
class DocAnnotationsList200ResponseAnnotationsItemLineActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLineActionsPageOpenRootType
    subtype: str
