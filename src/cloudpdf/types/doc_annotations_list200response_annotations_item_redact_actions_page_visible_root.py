...
class DocAnnotationsList200ResponseAnnotationsItemRedactActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemRedactActionsPageVisibleRootType
    subtype: str
