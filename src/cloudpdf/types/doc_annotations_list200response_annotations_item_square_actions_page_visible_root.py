...
class DocAnnotationsList200ResponseAnnotationsItemSquareActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquareActionsPageVisibleRootType
    subtype: str
