...
class DocAnnotationsList200ResponseAnnotationsItemStampActionsMouseDownRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStampActionsMouseDownRootType
    subtype: str
