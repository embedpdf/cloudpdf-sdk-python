...
class DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsBlurRootType
    subtype: str
