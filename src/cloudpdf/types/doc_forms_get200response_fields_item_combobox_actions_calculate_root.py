...
class DocFormsGet200ResponseFieldsItemComboboxActionsCalculateRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemComboboxActionsCalculateRootType
    subtype: str
