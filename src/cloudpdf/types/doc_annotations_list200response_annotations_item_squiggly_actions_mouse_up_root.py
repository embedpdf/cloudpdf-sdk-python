...
class DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsMouseUpRootType
    subtype: str
