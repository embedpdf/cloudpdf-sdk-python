...
class DocAnnotationsList200ResponseAnnotationsItemPolygonActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolygonActionsCursorEnterRootType
    subtype: str
