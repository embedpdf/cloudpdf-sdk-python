...
class DocAnnotationsList200ResponseAnnotationsItemLinkActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLinkActionsActivateRootType
    subtype: str
