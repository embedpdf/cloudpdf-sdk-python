...
class DocAnnotationsList200ResponseAnnotationsItemCaretActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCaretActionsPageOpenRootType
    subtype: str
