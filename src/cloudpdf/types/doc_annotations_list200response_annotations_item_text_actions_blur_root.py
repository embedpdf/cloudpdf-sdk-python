...
class DocAnnotationsList200ResponseAnnotationsItemTextActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemTextActionsBlurRootType
    subtype: str
