...
class DocFormsGet200ResponseFieldsItemSignatureActionsValidateRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemSignatureActionsValidateRootType
    subtype: str
