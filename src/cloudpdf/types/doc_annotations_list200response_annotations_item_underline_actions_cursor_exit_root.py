...
class DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsCursorExitRootType
    subtype: str
