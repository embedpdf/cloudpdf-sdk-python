...
class DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsPageOpenRootType
    subtype: str
