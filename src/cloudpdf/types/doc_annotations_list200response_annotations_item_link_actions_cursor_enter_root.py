...
class DocAnnotationsList200ResponseAnnotationsItemLinkActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLinkActionsCursorEnterRootType
    subtype: str
