...
class DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsMouseDownRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsMouseDownRootType
    subtype: str
