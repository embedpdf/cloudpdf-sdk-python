...
class DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsPageVisibleRootType
    subtype: str
