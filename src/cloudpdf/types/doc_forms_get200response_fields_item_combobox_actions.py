...
class DocFormsGet200ResponseFieldsItemComboboxActions(UniversalBaseModel):
    keystroke: typing.Optional[DocFormsGet200ResponseFieldsItemComboboxActionsKeystroke] = None
    format: typing.Optional[DocFormsGet200ResponseFieldsItemComboboxActionsFormat] = None
    validate_: typing_extensions.Annotated[
        typing.Optional[DocFormsGet200ResponseFieldsItemComboboxActionsValidate],
        FieldMetadata(alias="validate"),
        pydantic.Field(alias="validate"),
    ] = None
    calculate: typing.Optional[DocFormsGet200ResponseFieldsItemComboboxActionsCalculate] = None
