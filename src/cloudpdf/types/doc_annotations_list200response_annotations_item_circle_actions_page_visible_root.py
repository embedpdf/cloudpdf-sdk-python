...
class DocAnnotationsList200ResponseAnnotationsItemCircleActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCircleActionsPageVisibleRootType
    subtype: str
