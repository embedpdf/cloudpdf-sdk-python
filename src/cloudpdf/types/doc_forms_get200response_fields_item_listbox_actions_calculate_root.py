...
class DocFormsGet200ResponseFieldsItemListboxActionsCalculateRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemListboxActionsCalculateRootType
    subtype: str
