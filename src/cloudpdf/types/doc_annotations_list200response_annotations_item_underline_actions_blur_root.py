...
class DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsBlurRootType
    subtype: str
