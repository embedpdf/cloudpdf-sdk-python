...
class DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsPageOpenRootType
    subtype: str
