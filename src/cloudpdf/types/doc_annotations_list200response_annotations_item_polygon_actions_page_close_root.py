...
class DocAnnotationsList200ResponseAnnotationsItemPolygonActionsPageCloseRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolygonActionsPageCloseRootType
    subtype: str
