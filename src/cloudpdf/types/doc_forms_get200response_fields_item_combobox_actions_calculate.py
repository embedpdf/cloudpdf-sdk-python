...
class DocFormsGet200ResponseFieldsItemComboboxActionsCalculate(UniversalBaseModel):
    root: typing.Optional[DocFormsGet200ResponseFieldsItemComboboxActionsCalculateRoot] = None
    incomplete: bool
    warning_flags: typing_extensions.Annotated[
        int, FieldMetadata(alias="warningFlags"), pydantic.Field(alias="warningFlags")
    ]
    warnings: typing.List[DocFormsGet200ResponseFieldsItemComboboxActionsCalculateWarningsItem]
