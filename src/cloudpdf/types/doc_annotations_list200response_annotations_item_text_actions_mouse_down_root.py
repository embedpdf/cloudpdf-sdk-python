...
class DocAnnotationsList200ResponseAnnotationsItemTextActionsMouseDownRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemTextActionsMouseDownRootType
    subtype: str
