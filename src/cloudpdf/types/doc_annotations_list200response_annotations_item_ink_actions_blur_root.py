...
class DocAnnotationsList200ResponseAnnotationsItemInkActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemInkActionsBlurRootType
    subtype: str
