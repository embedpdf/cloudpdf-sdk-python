...
class DocAnnotationsList200ResponseAnnotationsItemHighlightActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemHighlightActionsMouseUpRootType
    subtype: str
