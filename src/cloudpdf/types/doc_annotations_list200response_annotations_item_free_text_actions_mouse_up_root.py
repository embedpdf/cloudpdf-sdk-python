...
class DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsMouseUpRootType
    subtype: str
