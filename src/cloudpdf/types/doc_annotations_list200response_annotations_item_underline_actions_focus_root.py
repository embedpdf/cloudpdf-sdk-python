...
class DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsFocusRootType
    subtype: str
