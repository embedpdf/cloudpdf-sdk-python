...
class DocAnnotationsList200ResponseAnnotationsItemLinkActionsPageCloseRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLinkActionsPageCloseRootType
    subtype: str
