...
class DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsPageInvisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsPageInvisibleRootType
    subtype: str
