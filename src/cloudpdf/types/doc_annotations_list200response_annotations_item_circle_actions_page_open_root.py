...
class DocAnnotationsList200ResponseAnnotationsItemCircleActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCircleActionsPageOpenRootType
    subtype: str
