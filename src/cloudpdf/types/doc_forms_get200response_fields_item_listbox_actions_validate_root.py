...
class DocFormsGet200ResponseFieldsItemListboxActionsValidateRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemListboxActionsValidateRootType
    subtype: str
