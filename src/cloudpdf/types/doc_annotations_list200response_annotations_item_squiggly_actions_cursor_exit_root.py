...
class DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsCursorExitRootType
    subtype: str
