...
class DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsFocusRootType
    subtype: str
