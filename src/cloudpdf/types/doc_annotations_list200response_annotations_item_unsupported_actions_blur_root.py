...
class DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsBlurRootType
    subtype: str
