...
class DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsPageInvisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsPageInvisibleRootType
    subtype: str
