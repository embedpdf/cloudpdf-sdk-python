...
class DocFormsGet200ResponseFieldsItemSignatureActionsFormatRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemSignatureActionsFormatRootType
    subtype: str
