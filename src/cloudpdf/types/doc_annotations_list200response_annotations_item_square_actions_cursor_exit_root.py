...
class DocAnnotationsList200ResponseAnnotationsItemSquareActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquareActionsCursorExitRootType
    subtype: str
