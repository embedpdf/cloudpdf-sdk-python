...
class DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsCursorEnterRootType
    subtype: str
