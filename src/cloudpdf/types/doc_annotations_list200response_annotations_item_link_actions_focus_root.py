...
class DocAnnotationsList200ResponseAnnotationsItemLinkActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLinkActionsFocusRootType
    subtype: str
