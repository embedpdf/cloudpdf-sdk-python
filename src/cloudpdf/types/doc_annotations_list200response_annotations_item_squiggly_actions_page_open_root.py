...
class DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsPageOpenRootType
    subtype: str
