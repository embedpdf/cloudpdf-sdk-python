...
class DocAnnotationsList200ResponseAnnotationsItemInkActionsPageInvisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemInkActionsPageInvisibleRootType
    subtype: str
