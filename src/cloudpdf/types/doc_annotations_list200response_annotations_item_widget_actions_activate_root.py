...
class DocAnnotationsList200ResponseAnnotationsItemWidgetActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemWidgetActionsActivateRootType
    subtype: str
