...
class DocAnnotationsList200ResponseAnnotationsItemTextActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemTextActionsActivateRootType
    subtype: str
