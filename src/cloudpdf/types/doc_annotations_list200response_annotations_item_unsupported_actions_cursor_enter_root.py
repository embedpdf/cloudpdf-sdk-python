...
class DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsCursorEnterRootType
    subtype: str
