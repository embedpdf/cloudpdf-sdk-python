...
class DocAnnotationsList200ResponseAnnotationsItemPolygonActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolygonActionsPageVisibleRootType
    subtype: str
