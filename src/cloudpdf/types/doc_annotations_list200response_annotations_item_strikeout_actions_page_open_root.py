...
class DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsPageOpenRootType
    subtype: str
