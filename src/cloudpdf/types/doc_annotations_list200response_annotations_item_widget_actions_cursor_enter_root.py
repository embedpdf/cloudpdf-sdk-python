...
class DocAnnotationsList200ResponseAnnotationsItemWidgetActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemWidgetActionsCursorEnterRootType
    subtype: str
