...
class DocAnnotationsList200ResponseAnnotationsItemTextActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemTextActionsFocusRootType
    subtype: str
