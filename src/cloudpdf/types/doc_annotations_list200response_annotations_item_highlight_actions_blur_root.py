...
class DocAnnotationsList200ResponseAnnotationsItemHighlightActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemHighlightActionsBlurRootType
    subtype: str
