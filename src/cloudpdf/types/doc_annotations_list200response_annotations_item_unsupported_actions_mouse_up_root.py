...
class DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsMouseUpRootType
    subtype: str
