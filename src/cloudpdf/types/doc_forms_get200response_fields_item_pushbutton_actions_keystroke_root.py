...
class DocFormsGet200ResponseFieldsItemPushbuttonActionsKeystrokeRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemPushbuttonActionsKeystrokeRootType
    subtype: str
