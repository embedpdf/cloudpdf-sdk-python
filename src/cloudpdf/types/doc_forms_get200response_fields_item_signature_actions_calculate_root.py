...
class DocFormsGet200ResponseFieldsItemSignatureActionsCalculateRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemSignatureActionsCalculateRootType
    subtype: str
