...
class DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsActivateRootType
    subtype: str
