...
class DocAnnotationsList200ResponseAnnotationsItemPolygonActionsPageInvisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolygonActionsPageInvisibleRootType
    subtype: str
