...
class DocAnnotationsList200ResponseAnnotationsItemTextActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemTextActionsCursorEnterRootType
    subtype: str
