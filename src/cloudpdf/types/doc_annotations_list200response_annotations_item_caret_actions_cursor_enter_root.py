...
class DocAnnotationsList200ResponseAnnotationsItemCaretActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCaretActionsCursorEnterRootType
    subtype: str
