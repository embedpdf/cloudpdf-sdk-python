...
class DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsPageInvisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsPageInvisibleRootType
    subtype: str
