...
class DocAnnotationsList200ResponseAnnotationsItemLinkActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLinkActionsMouseUpRootType
    subtype: str
