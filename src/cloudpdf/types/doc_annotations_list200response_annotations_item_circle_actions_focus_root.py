...
class DocAnnotationsList200ResponseAnnotationsItemCircleActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCircleActionsFocusRootType
    subtype: str
