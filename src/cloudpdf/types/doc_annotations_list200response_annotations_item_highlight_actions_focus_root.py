...
class DocAnnotationsList200ResponseAnnotationsItemHighlightActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemHighlightActionsFocusRootType
    subtype: str
