...
class DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsPageCloseRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsPageCloseRootType
    subtype: str
