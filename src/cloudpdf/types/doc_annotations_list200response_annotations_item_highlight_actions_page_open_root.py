...
class DocAnnotationsList200ResponseAnnotationsItemHighlightActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemHighlightActionsPageOpenRootType
    subtype: str
