...
class DocFormsGet200ResponseFieldsItemSignatureActionsKeystrokeRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemSignatureActionsKeystrokeRootType
    subtype: str
