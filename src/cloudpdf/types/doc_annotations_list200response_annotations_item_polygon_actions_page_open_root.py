...
class DocAnnotationsList200ResponseAnnotationsItemPolygonActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolygonActionsPageOpenRootType
    subtype: str
