...
class DocAnnotationsList200ResponseAnnotationsItemPolylineActionsPageInvisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolylineActionsPageInvisibleRootType
    subtype: str
