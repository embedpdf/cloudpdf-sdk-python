...
class DocFormsGet200ResponseFieldsItemUnknownActionsValidateRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemUnknownActionsValidateRootType
    subtype: str
