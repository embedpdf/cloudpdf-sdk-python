...
class DocAnnotationsList200ResponseAnnotationsItemPolygonActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolygonActionsBlurRootType
    subtype: str
