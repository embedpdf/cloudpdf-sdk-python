...
class DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsBlurRootType
    subtype: str
