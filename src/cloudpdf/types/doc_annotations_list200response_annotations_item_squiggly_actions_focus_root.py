...
class DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsFocusRootType
    subtype: str
