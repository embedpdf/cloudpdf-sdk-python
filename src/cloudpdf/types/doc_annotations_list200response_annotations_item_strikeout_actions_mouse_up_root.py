...
class DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsMouseUpRootType
    subtype: str
