...
class DocAnnotationsList200ResponseAnnotationsItemInkActionsMouseDownRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemInkActionsMouseDownRootType
    subtype: str
