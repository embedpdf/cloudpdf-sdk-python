...
class DocAnnotationsList200ResponseAnnotationsItemWidgetActionsMouseDownRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemWidgetActionsMouseDownRootType
    subtype: str
