...
class DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsPageVisibleRootType
    subtype: str
