...
class DocFormsGet200ResponseFieldsItemCheckboxActionsValidateRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemCheckboxActionsValidateRootType
    subtype: str
