...
class DocFormsGet200ResponseFieldsItemUnknownActionsCalculateRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemUnknownActionsCalculateRootType
    subtype: str
