...
class DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsPageOpenRootType
    subtype: str
