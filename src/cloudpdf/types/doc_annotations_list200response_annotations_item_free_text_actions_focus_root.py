...
class DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsFocusRootType
    subtype: str
