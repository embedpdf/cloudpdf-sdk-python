...
class DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsCursorExitRootType
    subtype: str
