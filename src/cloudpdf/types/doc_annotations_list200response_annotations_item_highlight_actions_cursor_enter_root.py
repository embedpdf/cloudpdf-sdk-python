...
class DocAnnotationsList200ResponseAnnotationsItemHighlightActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemHighlightActionsCursorEnterRootType
    subtype: str
