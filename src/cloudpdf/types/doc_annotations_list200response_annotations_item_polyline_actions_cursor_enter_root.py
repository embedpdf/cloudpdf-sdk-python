...
class DocAnnotationsList200ResponseAnnotationsItemPolylineActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolylineActionsCursorEnterRootType
    subtype: str
