...
class DocAnnotationsList200ResponseAnnotationsItemCaretActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCaretActionsCursorExitRootType
    subtype: str
