...
class DocAnnotationsList200ResponseAnnotationsItemInkActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemInkActionsMouseUpRootType
    subtype: str
