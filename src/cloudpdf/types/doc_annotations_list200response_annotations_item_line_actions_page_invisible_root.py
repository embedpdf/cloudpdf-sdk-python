...
class DocAnnotationsList200ResponseAnnotationsItemLineActionsPageInvisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLineActionsPageInvisibleRootType
    subtype: str
