...
class DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsPageVisibleRootType
    subtype: str
