...
class DocAnnotationsList200ResponseAnnotationsItemStampActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStampActionsActivateRootType
    subtype: str
