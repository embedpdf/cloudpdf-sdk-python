...
class DocAnnotationsList200ResponseAnnotationsItemRedactActionsPageCloseRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemRedactActionsPageCloseRootType
    subtype: str
