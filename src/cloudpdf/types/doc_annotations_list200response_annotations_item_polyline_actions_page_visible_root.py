...
class DocAnnotationsList200ResponseAnnotationsItemPolylineActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolylineActionsPageVisibleRootType
    subtype: str
