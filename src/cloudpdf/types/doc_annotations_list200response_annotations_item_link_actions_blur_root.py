...
class DocAnnotationsList200ResponseAnnotationsItemLinkActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLinkActionsBlurRootType
    subtype: str
