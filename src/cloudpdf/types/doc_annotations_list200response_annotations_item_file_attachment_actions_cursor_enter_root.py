...
class DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsCursorEnterRootType
    subtype: str
