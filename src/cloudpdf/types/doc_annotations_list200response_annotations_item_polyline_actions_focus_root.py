...
class DocAnnotationsList200ResponseAnnotationsItemPolylineActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolylineActionsFocusRootType
    subtype: str
