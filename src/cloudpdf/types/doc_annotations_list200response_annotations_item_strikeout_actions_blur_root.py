...
class DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsBlurRootType
    subtype: str
