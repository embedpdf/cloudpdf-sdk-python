...
class DocAnnotationsList200ResponseAnnotationsItemPolylineActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolylineActionsPageOpenRootType
    subtype: str
