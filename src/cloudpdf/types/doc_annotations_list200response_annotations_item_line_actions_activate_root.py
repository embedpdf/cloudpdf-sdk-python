...
class DocAnnotationsList200ResponseAnnotationsItemLineActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLineActionsActivateRootType
    subtype: str
