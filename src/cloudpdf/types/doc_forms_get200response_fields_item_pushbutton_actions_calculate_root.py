...
class DocFormsGet200ResponseFieldsItemPushbuttonActionsCalculateRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemPushbuttonActionsCalculateRootType
    subtype: str
