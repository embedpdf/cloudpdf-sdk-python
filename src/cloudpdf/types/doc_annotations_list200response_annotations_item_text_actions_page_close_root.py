...
class DocAnnotationsList200ResponseAnnotationsItemTextActionsPageCloseRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemTextActionsPageCloseRootType
    subtype: str
