...
class DocAnnotationsList200ResponseAnnotationsItemTextActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemTextActionsMouseUpRootType
    subtype: str
