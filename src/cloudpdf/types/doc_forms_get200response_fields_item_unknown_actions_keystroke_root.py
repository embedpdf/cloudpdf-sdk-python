...
class DocFormsGet200ResponseFieldsItemUnknownActionsKeystrokeRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemUnknownActionsKeystrokeRootType
    subtype: str
