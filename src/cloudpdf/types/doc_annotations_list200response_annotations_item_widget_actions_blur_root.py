...
class DocAnnotationsList200ResponseAnnotationsItemWidgetActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemWidgetActionsBlurRootType
    subtype: str
