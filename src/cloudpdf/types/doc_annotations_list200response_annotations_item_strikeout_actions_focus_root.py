...
class DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsFocusRootType
    subtype: str
