...
class DocAnnotationsList200ResponseAnnotationsItemLineActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLineActionsCursorEnterRootType
    subtype: str
