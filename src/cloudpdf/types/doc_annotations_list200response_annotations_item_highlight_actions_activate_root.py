...
class DocAnnotationsList200ResponseAnnotationsItemHighlightActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemHighlightActionsActivateRootType
    subtype: str
