...
class DocAnnotationsList200ResponseAnnotationsItemWidgetActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemWidgetActionsCursorExitRootType
    subtype: str
