...
class DocAnnotationsList200ResponseAnnotationsItemLinkActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLinkActionsPageOpenRootType
    subtype: str
