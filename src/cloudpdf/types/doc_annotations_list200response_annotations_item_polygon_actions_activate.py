...
class DocAnnotationsList200ResponseAnnotationsItemPolygonActionsActivate(UniversalBaseModel):
    root: typing.Optional[DocAnnotationsList200ResponseAnnotationsItemPolygonActionsActivateRoot] = None
    incomplete: bool
    warning_flags: typing_extensions.Annotated[
        int, FieldMetadata(alias="warningFlags"), pydantic.Field(alias="warningFlags")
    ]
    warnings: typing.List[DocAnnotationsList200ResponseAnnotationsItemPolygonActionsActivateWarningsItem]
