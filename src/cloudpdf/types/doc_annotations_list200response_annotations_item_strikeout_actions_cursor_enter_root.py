...
class DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsCursorEnterRootType
    subtype: str
