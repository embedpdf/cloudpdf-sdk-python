...
class DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsActivateRootType
    subtype: str
