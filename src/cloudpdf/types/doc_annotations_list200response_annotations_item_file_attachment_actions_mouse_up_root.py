...
class DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsMouseUpRootType
    subtype: str
