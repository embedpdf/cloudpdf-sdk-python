...
class DocAnnotationsList200ResponseAnnotationsItemRedactActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemRedactActionsBlurRootType
    subtype: str
