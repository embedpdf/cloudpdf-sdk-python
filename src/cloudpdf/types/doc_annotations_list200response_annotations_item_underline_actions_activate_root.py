...
class DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsActivateRootType
    subtype: str
