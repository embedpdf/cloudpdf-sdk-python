...
class DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsCursorEnterRootType
    subtype: str
