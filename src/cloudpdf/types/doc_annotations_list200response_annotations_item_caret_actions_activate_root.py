...
class DocAnnotationsList200ResponseAnnotationsItemCaretActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCaretActionsActivateRootType
    subtype: str
