...
class DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsCursorEnterRootType
    subtype: str
