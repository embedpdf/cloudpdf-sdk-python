...
class DocAnnotationsList200ResponseAnnotationsItemPolygonActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolygonActionsMouseUpRootType
    subtype: str
