...
class DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsPageCloseRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsPageCloseRootType
    subtype: str
