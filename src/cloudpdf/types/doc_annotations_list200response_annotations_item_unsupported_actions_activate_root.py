...
class DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsActivateRootType
    subtype: str
