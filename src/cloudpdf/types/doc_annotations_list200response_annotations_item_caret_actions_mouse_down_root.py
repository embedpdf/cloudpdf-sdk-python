...
class DocAnnotationsList200ResponseAnnotationsItemCaretActionsMouseDownRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCaretActionsMouseDownRootType
    subtype: str
