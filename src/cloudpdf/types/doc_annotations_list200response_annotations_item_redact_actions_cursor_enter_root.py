...
class DocAnnotationsList200ResponseAnnotationsItemRedactActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemRedactActionsCursorEnterRootType
    subtype: str
