...
class DocAnnotationsList200ResponseAnnotationsItemRedactActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemRedactActionsFocusRootType
    subtype: str
