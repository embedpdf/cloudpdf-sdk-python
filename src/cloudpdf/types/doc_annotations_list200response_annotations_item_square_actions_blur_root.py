...
class DocAnnotationsList200ResponseAnnotationsItemSquareActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquareActionsBlurRootType
    subtype: str
