...
class DocAnnotationsList200ResponseAnnotationsItemStampActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStampActionsCursorEnterRootType
    subtype: str
