...
class DocAnnotationsList200ResponseAnnotationsItemCircleActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCircleActionsBlurRootType
    subtype: str
