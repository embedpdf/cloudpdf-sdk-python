...
class DocAnnotationsList200ResponseAnnotationsItemSquareActionsPageClose(UniversalBaseModel):
    root: typing.Optional[DocAnnotationsList200ResponseAnnotationsItemSquareActionsPageCloseRoot] = None
    incomplete: bool
    warning_flags: typing_extensions.Annotated[
        int, FieldMetadata(alias="warningFlags"), pydantic.Field(alias="warningFlags")
    ]
    warnings: typing.List[DocAnnotationsList200ResponseAnnotationsItemSquareActionsPageCloseWarningsItem]
