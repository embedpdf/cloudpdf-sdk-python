...
class DocAnnotationsList200ResponseAnnotationsItemStampActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStampActionsPageOpenRootType
    subtype: str
