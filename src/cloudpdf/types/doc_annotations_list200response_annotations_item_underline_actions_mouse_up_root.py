...
class DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsMouseUpRootType
    subtype: str
