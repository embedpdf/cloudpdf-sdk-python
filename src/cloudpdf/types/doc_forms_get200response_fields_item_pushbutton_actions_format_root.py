...
class DocFormsGet200ResponseFieldsItemPushbuttonActionsFormatRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemPushbuttonActionsFormatRootType
    subtype: str
