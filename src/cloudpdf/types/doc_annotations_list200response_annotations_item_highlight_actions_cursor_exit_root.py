...
class DocAnnotationsList200ResponseAnnotationsItemHighlightActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemHighlightActionsCursorExitRootType
    subtype: str
