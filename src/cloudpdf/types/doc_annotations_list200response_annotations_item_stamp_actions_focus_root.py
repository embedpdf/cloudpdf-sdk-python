...
class DocAnnotationsList200ResponseAnnotationsItemStampActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStampActionsFocusRootType
    subtype: str
