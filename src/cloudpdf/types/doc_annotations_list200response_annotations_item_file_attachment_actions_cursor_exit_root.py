...
class DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsCursorExitRootType
    subtype: str
