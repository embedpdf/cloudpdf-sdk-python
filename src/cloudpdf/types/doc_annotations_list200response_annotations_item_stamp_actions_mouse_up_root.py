...
class DocAnnotationsList200ResponseAnnotationsItemStampActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStampActionsMouseUpRootType
    subtype: str
