...
class DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsMouseDownRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsMouseDownRootType
    subtype: str
