...
class DocAnnotationsList200ResponseAnnotationsItemLineActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLineActionsPageVisibleRootType
    subtype: str
