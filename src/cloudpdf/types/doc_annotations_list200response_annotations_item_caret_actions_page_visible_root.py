...
class DocAnnotationsList200ResponseAnnotationsItemCaretActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCaretActionsPageVisibleRootType
    subtype: str
