...
class DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsPageOpenRootType
    subtype: str
