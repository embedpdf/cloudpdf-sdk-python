...
class DocAnnotationsList200ResponseAnnotationsItemCircleActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCircleActionsCursorEnterRootType
    subtype: str
