...
class DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsMouseDownRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStrikeoutActionsMouseDownRootType
    subtype: str
