...
class DocAnnotationsList200ResponseAnnotationsItemSquareActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquareActionsActivateRootType
    subtype: str
