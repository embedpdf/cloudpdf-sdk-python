...
class DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsCursorExitRootType
    subtype: str
