...
class DocAnnotationsList200ResponseAnnotationsItemPolylineActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolylineActionsBlurRootType
    subtype: str
