...
class DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsPageCloseRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnderlineActionsPageCloseRootType
    subtype: str
