...
class DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsCursorExitRootType
    subtype: str
