...
class DocAnnotationsList200ResponseAnnotationsItemLineActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLineActionsBlurRootType
    subtype: str
