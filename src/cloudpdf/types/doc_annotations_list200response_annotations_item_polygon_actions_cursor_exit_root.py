...
class DocAnnotationsList200ResponseAnnotationsItemPolygonActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolygonActionsCursorExitRootType
    subtype: str
