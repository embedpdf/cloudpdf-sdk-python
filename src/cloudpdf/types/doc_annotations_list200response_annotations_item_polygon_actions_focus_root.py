...
class DocAnnotationsList200ResponseAnnotationsItemPolygonActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolygonActionsFocusRootType
    subtype: str
