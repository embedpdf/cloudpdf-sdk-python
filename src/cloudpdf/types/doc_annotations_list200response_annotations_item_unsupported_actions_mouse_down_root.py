...
class DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsMouseDownRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemUnsupportedActionsMouseDownRootType
    subtype: str
