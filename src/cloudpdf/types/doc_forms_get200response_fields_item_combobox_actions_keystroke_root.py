...
class DocFormsGet200ResponseFieldsItemComboboxActionsKeystrokeRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemComboboxActionsKeystrokeRootType
    subtype: str
