...
class DocAnnotationsList200ResponseAnnotationsItemCircleActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCircleActionsMouseUpRootType
    subtype: str
