...
class DocAnnotationsList200ResponseAnnotationsItemStampActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStampActionsCursorExitRootType
    subtype: str
