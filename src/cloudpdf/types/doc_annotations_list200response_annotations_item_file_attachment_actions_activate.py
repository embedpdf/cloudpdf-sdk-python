...
class DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsActivate(UniversalBaseModel):
    root: typing.Optional[DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsActivateRoot] = None
    incomplete: bool
    warning_flags: typing_extensions.Annotated[
        int, FieldMetadata(alias="warningFlags"), pydantic.Field(alias="warningFlags")
    ]
    warnings: typing.List[DocAnnotationsList200ResponseAnnotationsItemFileAttachmentActionsActivateWarningsItem]
