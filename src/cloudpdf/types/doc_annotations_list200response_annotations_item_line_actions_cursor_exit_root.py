...
class DocAnnotationsList200ResponseAnnotationsItemLineActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLineActionsCursorExitRootType
    subtype: str
