...
class DocAnnotationsList200ResponseAnnotationsItemSquareActionsFocusRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquareActionsFocusRootType
    subtype: str
