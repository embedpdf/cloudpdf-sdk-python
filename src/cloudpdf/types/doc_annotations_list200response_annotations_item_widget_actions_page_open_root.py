...
class DocAnnotationsList200ResponseAnnotationsItemWidgetActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemWidgetActionsPageOpenRootType
    subtype: str
