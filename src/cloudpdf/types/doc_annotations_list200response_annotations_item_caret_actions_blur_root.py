...
class DocAnnotationsList200ResponseAnnotationsItemCaretActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCaretActionsBlurRootType
    subtype: str
