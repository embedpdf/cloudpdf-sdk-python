...
class DocAnnotationsList200ResponseAnnotationsItemPolygonActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolygonActionsActivateRootType
    subtype: str
