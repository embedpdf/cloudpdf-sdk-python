...
class DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsBlurRootType
    subtype: str
