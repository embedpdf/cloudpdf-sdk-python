...
class DocFormsGet200ResponseFieldsItemCheckboxActionsKeystrokeRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemCheckboxActionsKeystrokeRootType
    subtype: str
