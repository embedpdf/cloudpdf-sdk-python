...
class DocAnnotationsList200ResponseAnnotationsItemHighlightActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemHighlightActionsPageVisibleRootType
    subtype: str
