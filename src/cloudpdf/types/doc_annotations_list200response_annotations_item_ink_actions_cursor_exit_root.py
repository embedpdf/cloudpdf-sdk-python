...
class DocAnnotationsList200ResponseAnnotationsItemInkActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemInkActionsCursorExitRootType
    subtype: str
