...
class DocAnnotationsList200ResponseAnnotationsItemLinkActionsMouseDownRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLinkActionsMouseDownRootType
    subtype: str
