...
class DocAnnotationsList200ResponseAnnotationsItemStampActionsBlurRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemStampActionsBlurRootType
    subtype: str
