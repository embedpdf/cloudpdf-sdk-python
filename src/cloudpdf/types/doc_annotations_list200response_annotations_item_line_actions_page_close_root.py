...
class DocAnnotationsList200ResponseAnnotationsItemLineActionsPageCloseRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemLineActionsPageCloseRootType
    subtype: str
