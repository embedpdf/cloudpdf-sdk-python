...
class DocAnnotationsList200ResponseAnnotationsItemWidgetActionsPageVisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemWidgetActionsPageVisibleRootType
    subtype: str
