...
class DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemSquigglyActionsActivateRootType
    subtype: str
