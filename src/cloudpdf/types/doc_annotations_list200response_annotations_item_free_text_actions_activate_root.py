...
class DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemFreeTextActionsActivateRootType
    subtype: str
