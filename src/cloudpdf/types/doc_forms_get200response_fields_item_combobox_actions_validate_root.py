...
class DocFormsGet200ResponseFieldsItemComboboxActionsValidateRoot(UniversalBaseModel):
    type: DocFormsGet200ResponseFieldsItemComboboxActionsValidateRootType
    subtype: str
