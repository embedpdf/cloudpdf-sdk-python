...
class DocAnnotationsList200ResponseAnnotationsItemRedactActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemRedactActionsMouseUpRootType
    subtype: str
