...
class DocAnnotationsList200ResponseAnnotationsItemPolylineActionsMouseDownRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolylineActionsMouseDownRootType
    subtype: str
