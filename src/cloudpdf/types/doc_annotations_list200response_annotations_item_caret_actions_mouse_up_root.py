...
class DocAnnotationsList200ResponseAnnotationsItemCaretActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCaretActionsMouseUpRootType
    subtype: str
