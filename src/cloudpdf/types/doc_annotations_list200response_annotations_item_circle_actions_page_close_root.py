...
class DocAnnotationsList200ResponseAnnotationsItemCircleActionsPageCloseRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCircleActionsPageCloseRootType
    subtype: str
