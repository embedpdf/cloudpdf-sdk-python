...
class DocAnnotationsList200ResponseAnnotationsItemTextActionsPageInvisibleRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemTextActionsPageInvisibleRootType
    subtype: str
