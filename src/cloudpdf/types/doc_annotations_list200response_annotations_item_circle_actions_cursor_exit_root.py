...
class DocAnnotationsList200ResponseAnnotationsItemCircleActionsCursorExitRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemCircleActionsCursorExitRootType
    subtype: str
