...
class DocAnnotationsList200ResponseAnnotationsItemPolylineActionsPageCloseRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolylineActionsPageCloseRootType
    subtype: str
