...
class DocFormsGet200ResponseFieldsItemCheckboxActions(UniversalBaseModel):
    keystroke: typing.Optional[DocFormsGet200ResponseFieldsItemCheckboxActionsKeystroke] = None
    format: typing.Optional[DocFormsGet200ResponseFieldsItemCheckboxActionsFormat] = None
    validate_: typing_extensions.Annotated[
        typing.Optional[DocFormsGet200ResponseFieldsItemCheckboxActionsValidate],
        FieldMetadata(alias="validate"),
        pydantic.Field(alias="validate"),
    ] = None
    calculate: typing.Optional[DocFormsGet200ResponseFieldsItemCheckboxActionsCalculate] = None
