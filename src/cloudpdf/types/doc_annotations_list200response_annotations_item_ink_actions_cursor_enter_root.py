...
class DocAnnotationsList200ResponseAnnotationsItemInkActionsCursorEnterRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemInkActionsCursorEnterRootType
    subtype: str
