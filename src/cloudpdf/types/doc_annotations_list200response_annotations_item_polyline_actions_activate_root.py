...
class DocAnnotationsList200ResponseAnnotationsItemPolylineActionsActivateRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemPolylineActionsActivateRootType
    subtype: str
