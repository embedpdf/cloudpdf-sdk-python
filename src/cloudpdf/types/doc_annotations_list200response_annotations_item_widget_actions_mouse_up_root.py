...
class DocAnnotationsList200ResponseAnnotationsItemWidgetActionsMouseUpRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemWidgetActionsMouseUpRootType
    subtype: str
