...
class DocAnnotationsList200ResponseAnnotationsItemInkActionsPageOpenRoot(UniversalBaseModel):
    type: DocAnnotationsList200ResponseAnnotationsItemInkActionsPageOpenRootType
    subtype: str
