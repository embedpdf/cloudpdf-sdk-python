...
class CloudPDFClient:
    ...
    def deployment(self):
        if self._deployment is None:
            from .deployment.client import DeploymentClient  # noqa: E402
    ...
    def doc(self):
        if self._doc is None:
            from .doc.client import DocClient  # noqa: E402
...
class AsyncCloudPDFClient:
    ...
    def deployment(self):
        if self._deployment is None:
            from .deployment.client import AsyncDeploymentClient  # noqa: E402
    ...
    def doc(self):
        if self._doc is None:
            from .doc.client import AsyncDocClient  # noqa: E402
